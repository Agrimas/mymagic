					...
					<div class="row justify-content-center">
						<div class="col col-lg-7">
							<form action="" method="post" id="ajax_form_1">
								<input name="phone_number" class="phone_input my-2 px-4 py-3" type="text" placeholder="Ваш телефон" required>
		...
		<div class="container">
			<div class="row m-0 p-0 h-100 align-items-center">
				<div class="col">
					...
					<div id="slider-block-about-profession" class="row justify-content-center mb-4 carousel slide" data-ride="carousel">

						<div class="col-2 d-none d-md-flex justify-content-end align-items-center">
							<a href="#slider-block-about-profession" role="button" data-slide="prev">
								<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="100px" height=100px" viewBox="0 0 100.000000 100.000000" preserveAspectRatio="xMidYMid meet">

									<g transform="translate(0.000000,100.000000) scale(0.100000,-0.100000)" fill="#d7463f" stroke="none">
						...
						<div class="col-md-8">
							<div class="carousel-inner" data-ride="false" data-touch="false">
								...
								<div class="carousel-item active" data-ride="false" data-touch="false">
									...
									<img src="img/photo/slider_about_profession/photo-1.jpg" alt="Первый слайд">
								...
								<div class="carousel-item" data-ride="false" data-touch="false">
									...
									<img src="img/photo/slider_about_profession/photo-2.jpg" alt="Первый слайд">
								...
								<div class="carousel-item" data-ride="false" data-touch="false">
									...
									<img src="img/photo/slider_about_profession/photo-3.jpg" alt="Первый слайд">
								...
								<div class="carousel-item" data-ride="false" data-touch="false">
									...
									<img src="img/photo/slider_about_profession/photo-4.jpg" alt="Первый слайд">
								...
								<div class="carousel-item" data-ride="false" data-touch="false">
									...
									<img src="img/photo/slider_about_profession/photo-5.jpg" alt="Первый слайд">
								...
								<div class="carousel-item" data-ride="false" data-touch="false">
									...
									<img src="img/photo/slider_about_profession/photo-6.jpg" alt="Первый слайд">
						...
						<div class="col-2 d-none d-md-flex align-items-center">
							<a class="" href="#slider-block-about-profession" role="button" data-slide="next">
								<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="100px" height=100px" viewBox="0 0 100.000000 100.000000" preserveAspectRatio="xMidYMid meet">
						...
						<div class="col p-0">
							<div class="wrap">
								<a href="img/photo/slider_block_photo/image_<?= $x ?>.jpg" data-fancybox>
									<img alt="" class="image" src="img/photo/slider_block_photo/image_<?= $x ?>.jpg">
									<div class="mask"></div>
								</a>
							</div>
						</div>
				...
				<div class="row justify-content-center carousel slide d-flex">
					...
					<div class="col-2 d-none d-md-flex justify-content-center align-items-center">
						<a class="" href="#slider_block_video" role="button" data-slide="prev">
							<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="100.000000px" height="100.000000px" viewBox="0 0 100.000000 100.000000" preserveAspectRatio="xMidYMid meet">
					...
					<div class="col col-md-8 col-lg-6">
						<div class="carousel-inner border-slider p-2">
							...
							<div class="carousel-item active">
								<div class="video">
									<a class="video__link" href="https://vimeo.com/455755611">
							...
							<div class="carousel-item">
								<div class="video youtube">
									<a class="video__link" href="https://youtu.be/pWYbL_j_MEo">
										<!-- Здесь заменить pWYbL_j_MEo на id видео-->
										<picture>
											...
											<img class="video__media video__media__youtube" src="https://i.ytimg.com/vi/pWYbL_j_MEo/maxresdefault.jpg" alt=""> <!-- Здесь заменить pWYbL_j_MEo на id видео-->
										</picture>
									</a>
									<button class="video__button" type="button" aria-label="Запустить видео">
										<svg width="68" height="48" viewBox="0 0 68 48">
								...
								<div class="video youtube">
									<a class="video__link" href="https://youtu.be/zCm6NsqJLWE">
										<picture>
											...
											<img class="video__media" src="https://i.ytimg.com/vi/zCm6NsqJLWE/maxresdefault.jpg" alt="">
										</picture>
									</a>
									<button class="video__button" type="button" aria-label="Запустить видео">
										<svg width="68" height="48" viewBox="0 0 68 48">
					...
					<div class="col-2 d-none d-md-flex justify-content-center align-items-center">
						<a class="" href="#slider_block_video" role="button" data-slide="next">
							<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="100.000000px" height="100.000000px" viewBox="0 0 100.000000 100.000000" preserveAspectRatio="xMidYMid meet">
				...
				<div class="col-md-6 col-lg-4 d-flex flex-column justify-content-center mt-5 mt-md-0">
					...
					<ul class="nav justify-content-center p-0 mt-3">
						<li class="nav-item mx-1">
							<a class="social rounded-circle" href="https://www.instagram.com/justmymagic/" target="_blank">
								<i class="fab fa-instagram"></i>
							</a>
						</li>
						<li class="nav-item mx-1">
							<a class="social rounded-circle" href="https://vk.com/focusnik_illusionist_minsk/" target="_blank">
								<i class="fab fa-vk"></i>
							</a>
						</li>
						<li class="nav-item mx-1">
							<a class="social rounded-circle" href="https://www.facebook.com/justmymagic/" target="_blank">
								<i class="fab fa-facebook-f"></i>
							</a>
						</li>

						<li class="nav-item mx-1">
							<a class="social rounded-circle" href="https://t.me/justmymagic/" target="_blank">
						...
						<li class="nav-item mx-1">
							<a class="social rounded-circle" href="https://ok.ru/profile/359503298009/" target="_blank">
								<i class="fab fa-odnoklassniki"></i>
							</a>
						</li>
					</ul>
			...
			<div class="row mt-5 m-0">
				...
				<div class="col col-md-4 text-md-center">
					<a href="#first-block" class="logo-link">
						<svg width="30px" height="30px" version="1.1" id="ico-to-top" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
