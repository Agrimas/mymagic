...
<section class="first-block" id="first-block">
    ...
    <div class="px-md-3 px-xl-5 ">
        ...
        <div class="sale-button">
            <button class="text-uppercase">получить скидку</button>
        </div>
...
<section class="block-about" id="block-about">
    <div class="row h-100 px-md-5 m-0 align-items-lg-center">
        <div class="col-lg-6 px-3">
            ...
            <p class="mb-0 mt-4" id="illusionist">Иллюзионист <br>
                <span class="text-uppercase m-0">Антон Ермоленко</span>
            </p>
            <div class="block-about-list col my-4 px-3 px-xl-4 py-4 py-xl-5">
                <ul class="m-0 p-0 text-right ">
                    <li class="mb-3 pr-5">Профессионально занимаюсь фокусами более 8 лет</li>
                    <li class="mb-3 pr-5">Представитель Российской Ассоциации Иллюзионистов (РАИ)</li>
                    <li class="pr-5">Представитель Международного Сообщества Иллюзионистов (ISM)</li>
                </ul>
            </div>
                                ...
                                <div class="carousel-inner" data-ride="false" data-touch="false">
                                    <div class="carousel-item active" data-ride="false" data-touch="false">
                                        <div class="row d-flex justify-content-center m-0">
                                            ...
                                            <div class="slide-title active col-12 d-md-block mt-3 mt-lg-4 p-3">
                                                <p class="m-auto col">Выступление на свадьбе (программа 20-25 минут)</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="carousel-item" data-ride="false" data-touch="false">
                                        <div class="row d-flex justify-content-center m-0">
                                            ...
                                            <div class="slide-title active col-12 d-md-block mt-3 mt-lg-4 p-3">
                                                <p class="m-auto col">Выступление на корпоративе (программа 20-25
                                                    минут)</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="carousel-item" data-ride="false" data-touch="false">
                                        <div class="row d-flex justify-content-center m-0">
                                            ...
                                            <div class="slide-title active col-12 d-md-block mt-3 mt-lg-4 p-3">
                                                <p class="m-auto col">Выступление на дне Рождения (программа 20-25
                                                    минут)</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="carousel-item" data-ride="false" data-touch="false">
                                        <div class="row d-flex justify-content-center m-0">
                                            ...
                                            <div class="slide-title active col-12 d-md-block mt-3 mt-lg-4 p-3">
                                                <p class="m-auto col">Выступление на детском празднике (программа 20-25
                                                    минут)</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="carousel-item" data-ride="false" data-touch="false">
                                        <div class="row d-flex justify-content-center m-0">
                                            ...
                                            <div class="slide-title active col-12 d-md-block mt-3 mt-lg-4 p-3">
                                                <p class="m-auto col">Встреча гостей, интерактив с гостями, микромагия
                                                    (программа
                                                    20-25
                                                    минут)</p>
                                            </div>
                                    ...
                                    <div class="carousel-item" data-ride="false" data-touch="false">
                                        <div class="row d-flex justify-content-center m-0">
                                            ...
                                            <div class="slide-title active col-12 d-md-block mt-3 mt-lg-4 p-3">
                                                <p class="m-auto col">Выступление на тематических мероприятиях
                                                    (время оговаривается индивидуально)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container-fluid">
                                <div class="row mt-3 mt-lg-5 justify-content-center">
                                    <div class="col col-xl-12">
                                        <ol class="carousel-indicators d-flex flex-wrap flex-lg-nowrap justify-content-around m-0"
                                            ...
                                            <li data-target="#slider-block-about-profession" data-slide-to="0"
                                                ...
                                                Выступление на свадьбе (программа 20-25 минут)
                                            </li>
                                            <li data-target="#slider-block-about-profession" data-slide-to="1"
                                                data-ride="false"
                                                data-touch="false">
                                                Выступление на корпоративе (программа 20-25 минут)
                                            </li>
                                            <li data-target="#slider-block-about-profession" data-slide-to="2"
                                                data-ride="false"
                                                data-touch="false">
                                                Выступление на дне Рождения (программа 20-25 минут)
                                            </li>
                                            <li data-target="#slider-block-about-profession" data-slide-to="3"
                                                data-ride="false"
                                                data-touch="false">
                                                Выступление на детском празднике (программа 20-25 минут)
                                            </li>
                                            ...
                                            <li data-target="#slider-block-about-profession" data-slide-to="5"
                                                data-ride="false"
                                                data-touch="false">
                                                Выступление на тематических мероприятиях (время оговаривается
                                                индивидуально)
                                            </li>
                                        </ol>
                                    </div>
        ...
        <div class="col-5 d-flex flex-column justify-content-center">
            <div class="bg-sale-title d-flex justify-content-center mb-lg-5">
                <div class="sale-title py-md-2 py-lg-3 pl-3 pl-lg-0">
                    <p>Закажите выступление <br> сейчас и получите <br> <span id="sale-title__item"
                        >скидку 30%</span>
                    </p>
                </div>
            </div>
            <div class="sale-button text-center my-md-2 my-5 p-1">
                <button class="text-uppercase">получить скидку</button>
            </div>
        </div>
        <div class="col">
...
<section class="block-clients d-none" id="block-clients">
    ...
    <div class="container-fluid py-3 py-lg-5">
        ...
        <div class="row justify-content-center px-5 px-xl-0">
                ...
                <div class="row justify-content-center">
                    <div class="col-10 col-xl-8">
                        ...
                        <div class="row">
                            ...
                            <img src="img/icon/magic.svg" alt="" width="30px" height="30px" class="offset-1">
                        </div>
                        ...
                        <div class="row flex-column">
                            ...
                            <div class="col-xl-8 mt-3">
                                <ul class="nav d-flex justify-content-around flex-nowrap p-0">
                                    <li class="nav-item">
                                        <a class="social nav-link rounded-circle"
                                           href="#">
                                            <i class="fab fa-instagram"></i>
                                        </a>
                                    </li>
